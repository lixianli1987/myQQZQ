//
//  MyHistoryActivityViewController.m
//  QQZQ
//
...
@interface MyHistoryActivityViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation MyHistoryActivityViewController
...
{
    NSLog(@"进来没");
    static NSString *identifier = @"HistoryActivityTableViewCell";
    
    HistoryActivityTableViewCell *cell = (HistoryActivityTableViewCell *)[tableViews dequeueReusableCellWithIdentifier:identifier];
    if (cell==nil) {
